...
| **Место** | Иркутск, мкр. Солнечный: большой зал на 160 мест, два малых зала (БУ и СО) по ~40 мест, проживание от 1 500 ₽/сутки, столовая на территории |
...
├── og-image.png                  # Превью-картинка для соцсетей (Open Graph)
├── assets/
